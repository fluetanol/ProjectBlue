...
public class PlayerAnimationControl : MonoBehaviour
{
    ...
    void Awake()
    {
        _componentManager = GetComponentInParent<PlayerComponentManager>();
        _inputActionControll = GetComponentInParent<IInputActionControll>();
    }

    void OnEnable()
    {
        _inputActionControll.OnMove(SetAnimMove, SetAnimMoveCancel);
        _inputActionControll.OnAttack(SetAnimClick, SetAnimClickCancel);
    }


    public void SetAnimMove(InputAction.CallbackContext context)
    {
        _componentManager.Animator.SetBool("IsMove", true);
    }

    private void SetAnimMoveCancel(InputAction.CallbackContext context)
    {
        _componentManager.Animator.SetBool("IsMove", false);
    }

    private void SetAnimClick(InputAction.CallbackContext context)
    {
        _componentManager.Animator.SetBool("IsClicked", true);
    }

    private void SetAnimClickCancel(InputAction.CallbackContext context)
    {
        _componentManager.Animator.SetBool("IsClicked", false);
    }
    ...
    //     //print("OnAnimatorIK");
    //     if (_componentManager.Animator)
    //     {
    //         // Left Foot
    //         // Position 과 Rotation weight 설정
    //         _componentManager.Animator.SetIKPositionWeight(AvatarIKGoal.LeftFoot, 1);
    //         _componentManager.Animator.SetIKRotationWeight(AvatarIKGoal.LeftFoot, 1);
    ...
    //         ///</summary>
    //         Ray leftRay = new Ray(_componentManager.Animator.GetIKPosition(AvatarIKGoal.LeftFoot) + Vector3.up, Vector3.down);
    ...
    //                 _componentManager.Animator.SetIKPosition(AvatarIKGoal.LeftFoot, footPosition);
    //                 _componentManager.Animator.SetIKRotation(AvatarIKGoal.LeftFoot, Quaternion.LookRotation(transform.forward, leftHit.normal));
    //             }
    //         }

    //         // Right Foot
    //         _componentManager.Animator.SetIKPositionWeight(AvatarIKGoal.RightFoot, 1);
    //         _componentManager.Animator.SetIKRotationWeight(AvatarIKGoal.RightFoot, 1);

    //         Ray rightRay = new Ray(_componentManager.Animator.GetIKPosition(AvatarIKGoal.RightFoot) + Vector3.up, Vector3.down);
    ...
    //                 _componentManager.Animator.SetIKPosition(AvatarIKGoal.RightFoot, footPosition);
    //                 _componentManager.Animator.SetIKRotation(AvatarIKGoal.RightFoot, Quaternion.LookRotation(transform.forward, rightHit.normal));
    //             }
    //         }
    //     }
